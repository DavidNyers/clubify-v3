...
-- Demo Clubs
INSERT INTO public.clubs (id, owner_id, name, slug, description, address, city, lat, lng, capacity, price_range, music_genres, status, featured, images) VALUES
  ('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000002',
   ...
   ARRAY['https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&q=80&w=800']),
  ...
  ('10000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002',
   ...
   ARRAY['https://images.unsplash.com/photo-1545128485-c400e7702796?auto=format&fit=crop&q=80&w=800']),
  ...
  ('10000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000002',
   ...
   ARRAY['https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&q=80&w=800'])
ON CONFLICT (id) DO NOTHING;

-- Demo Bars
INSERT INTO public.bars (id, owner_id, name, slug, description, address, city, lat, lng, capacity, price_range, status, featured, images) VALUES
  ('20000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000003',
   ...
   ARRAY['https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?auto=format&fit=crop&q=80&w=800']),
  ...
  ('20000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000003',
   ...
   ARRAY['https://images.unsplash.com/photo-1572116469696-31de0f17cc34?auto=format&fit=crop&q=80&w=800'])
ON CONFLICT (id) DO NOTHING;
...
-- Demo Events
INSERT INTO public.events (id, club_id, manager_id, name, slug, description, date, doors_open, max_guests, ticket_price, currency, lineup, genre, status, featured, images) VALUES
  ('30000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000004',
   ...
   'published', true,
   ARRAY['https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&q=80&w=800']),
  ...
  ('30000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000004',
   ...
   'published', true,
   ARRAY['https://images.unsplash.com/photo-1511192336575-5a79af67a629?auto=format&fit=crop&q=80&w=800'])
ON CONFLICT (id) DO NOTHING;
