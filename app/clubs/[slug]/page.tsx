      ...
      <main style={{ minHeight: '100vh', paddingBottom: 80, background: '#09090b', color: '#f1f5f9' }}>
        ...
        <div className="details-grid" style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 5%' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            {/* Info Box */}
            <div style={{ background: '#18181b', border: '1px solid #27272a', borderRadius: 24, padding: 24, position: 'sticky', top: 100 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  {club.website && (
                    <a href={club.website} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', gap: 12, alignItems: 'center', color: '#a1a1aa', textDecoration: 'none', fontSize: '0.9rem' }} className="hover-text-primary">
                      <Globe size={18} /> Webseite besuchen
                    </a>
                  )}
                  {club.instagram && (
                    <a href={`https://instagram.com/${club.instagram.replace('@', '')}`} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', gap: 12, alignItems: 'center', color: '#a1a1aa', textDecoration: 'none', fontSize: '0.9rem' }} className="hover-text-primary">
                      <Camera size={18} /> Instagram
                    </a>
                  )}
                  {club.phone && (
                    <div style={{ display: 'flex', gap: 12, alignItems: 'center', color: '#a1a1aa', fontSize: '0.9rem' }}>
